...
from crawlers.multi_framework_crawler.multi_framework_spider import run_crawler, run_crawler_test  # Import your function here
...
@app.route('/start-crawl-test', methods=['POST'])
def start_crawl_test():
    return run_crawler_test()
